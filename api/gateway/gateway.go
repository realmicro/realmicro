// Package gateway provides HTTP API gateway functionality for realmicro services.
//
// The API gateway translates HTTP requests into RPC calls and serves a web dashboard
// for browsing and calling services. It can be used in development (realmicro run) or
// production (realmicro server) with optional authentication.
package gateway
