...
import (
	...
	"github.com/realmicro/realmicro/cmd/protoc-gen-realmicro/generator"
...
const (
	apiPkgPath     = "github.com/realmicro/realmicro/api"
	contextPkgPath = "context"
	clientPkgPath  = "github.com/realmicro/realmicro/client"
	serverPkgPath  = "github.com/realmicro/realmicro/server"
)

func init() {
	generator.RegisterPlugin(new(realmicro))
}

// realmicro is an implementation of the Go protocol buffer compiler's
// plugin architecture.  It generates bindings for go-realmicro support.
type realmicro struct {
	gen *generator.Generator
}

// Name returns the name of this plugin, "realmicro".
func (g *realmicro) Name() string {
	return "realmicro"
}
...
func (g *realmicro) Init(gen *generator.Generator) {
	g.gen = gen
...
func (g *realmicro) objectNamed(name string) generator.Object {
	g.gen.RecordTypeUse(name)
	return g.gen.ObjectNamed(name)
}

// Given a type name defined in a .proto, return its name as we will print it.
func (g *realmicro) typeName(str string) string {
	return g.gen.TypeName(g.objectNamed(str))
}

// P forwards to g.gen.P.
func (g *realmicro) P(args ...interface{}) { g.gen.P(args...) }

// Generate generates code for the services in the given file.
func (g *realmicro) Generate(file *generator.FileDescriptor) {
...
func (g *realmicro) GenerateImports(file *generator.FileDescriptor, imports map[generator.GoImportPath]generator.GoPackageName) {
	if len(file.FileDescriptorProto.Service) == 0 {
		return
	}
	g.P("import (")
...
var reservedClientName = map[string]bool{
	// TODO: do we need any in go-realmicro?
}
...
func (g *realmicro) generateService(file *generator.FileDescriptor, service *pb.ServiceDescriptorProto, index int) {
...
func (g *realmicro) generateEndpoint(servName string, method *pb.MethodDescriptorProto) {
	if method.Options == nil || !proto.HasExtension(method.Options, options.E_Http) {
		return
	}
	// http rules
...
func (g *realmicro) generateClientSignature(servName string, method *pb.MethodDescriptorProto) string {
...
func (g *realmicro) generateClientMethod(reqServ, servName, serviceDescVar string, method *pb.MethodDescriptorProto, descExpr string) {
...
func (g *realmicro) generateServerSignature(servName string, method *pb.MethodDescriptorProto) string {
	origMethName := method.GetName()
	methName := generator.CamelCase(origMethName)
	if reservedClientName[methName] {
		methName += "_"
...
func (g *realmicro) generateServerMethod(servName string, method *pb.MethodDescriptorProto) string {
	methName := generator.CamelCase(method.GetName())
