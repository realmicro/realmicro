...
import (
	...
	mmath "github.com/realmicro/realmicro/common/util/math"
	"github.com/realmicro/realmicro/common/util/proc"
...
func (ew *errorWindow) add(reason string) {
	ew.lock.Lock()
	ew.reasons[ew.index] = fmt.Sprintf("%s %s", mtime.Time().Format(timeFormat), reason)
